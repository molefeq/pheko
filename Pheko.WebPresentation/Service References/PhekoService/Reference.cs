...
namespace Pheko.WebPresentation.PhekoService {
    ...
    public interface IPhekoService {
        ...
        Pheko.WebPresentation.PhekoService.PatientDtoResult Search(Pheko.Common.DataTransformObjects.PatientDto searchPatient);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPhekoService/Search", ReplyAction="http://tempuri.org/IPhekoService/SearchResponse")]
        System.Threading.Tasks.Task<Pheko.WebPresentation.PhekoService.PatientDtoResult> SearchAsync(Pheko.Common.DataTransformObjects.PatientDto searchPatient);
        ...
        Pheko.WebPresentation.PhekoService.PatientConsultationDtoResult GetPatientConsultations(int patientId, string searchText);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPhekoService/GetPatientConsultations", ReplyAction="http://tempuri.org/IPhekoService/GetPatientConsultationsResponse")]
        System.Threading.Tasks.Task<Pheko.WebPresentation.PhekoService.PatientConsultationDtoResult> GetPatientConsultationsAsync(int patientId, string searchText);
    ...
    public partial class PhekoServiceClient : System.ServiceModel.ClientBase<Pheko.WebPresentation.PhekoService.IPhekoService>, Pheko.WebPresentation.PhekoService.IPhekoService {
        ...
        public Pheko.WebPresentation.PhekoService.PatientDtoResult Search(Pheko.Common.DataTransformObjects.PatientDto searchPatient) {
            return base.Channel.Search(searchPatient);
        }
        
        public System.Threading.Tasks.Task<Pheko.WebPresentation.PhekoService.PatientDtoResult> SearchAsync(Pheko.Common.DataTransformObjects.PatientDto searchPatient) {
        ...
        public Pheko.WebPresentation.PhekoService.PatientConsultationDtoResult GetPatientConsultations(int patientId, string searchText) {
            return base.Channel.GetPatientConsultations(patientId, searchText);
        }
        
        public System.Threading.Tasks.Task<Pheko.WebPresentation.PhekoService.PatientConsultationDtoResult> GetPatientConsultationsAsync(int patientId, string searchText) {
