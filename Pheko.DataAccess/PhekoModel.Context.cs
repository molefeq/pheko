...
namespace Pheko.DataAccess
{
    ...
    public partial class PhekoEntities : DbContext
    {
        ...
        public virtual int pat_PatientConsultationSickNoteSchedule(Nullable<int> userId, Nullable<int> patientConsultationId, ObjectParameter infoMsg)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pat_PatientConsultationSickNoteSchedule", userIdParameter, patientConsultationIdParameter, infoMsg);
        }
